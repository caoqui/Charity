...
let charity = (_dec = NearBindgen({}), _dec2 = initialize(), _dec3 = view(), _dec4 = view(), _dec5 = call({
  ...
  privateFunction: true
}), _dec10 = call({}), _dec(_class = (_class2 = class charity {
  constructor() {
  ...
  addPhilanthropist({
    ...
    try {
      if (!this.listPhilanthropist.get(philanthropist)) {
        ...
        log("This account existed.");
      }
    } catch (error) {
      log("Create philanthropist failure.");
    }
  }
  addRegister() {
    try {
      if (!this.listRegister.get(signerAccountId())) {
        this.listRegister.set(signerAccountId(), true);
        log("register successfully!");
      } else {
        log("The account existed in list.");
      }
    } catch (error) {
      log("Cant add this register");
    }
  }
  contributePrice({
    idPhilanthropist
    ...
    if (amount > BigInt(0)) {
      const newAmount = BigInt(this.listPhilanthropist.get(idPhilanthropist)) + amount;
      this.listPhilanthropist.set(idPhilanthropist, String(newAmount));
      log(signerAccountId(), " contributed to ", idPhilanthropist, amount);
    }
  }
  removeRegister({
    idRegister
    ...
    log("Removed register ", idRegister, "sccessfully!");
  }
  acceptRegister({
    idRegister
  }) {
    ...
    log("Accepted", idRegister, "sccessfully!");
  }
  reedemOne() {
    if (!this.listPhilanthropist.get(signerAccountId())) return;else {
      const value = this.listPhilanthropist.get(signerAccountId());
      const reedemAmount = BigInt(value);
      this.listPhilanthropist.remove(signerAccountId());
      log("Reedem successfully!.");
      return NearPromise.new(signerAccountId()).transfer(reedemAmount);
    }
  }
}, (_applyDecoratedDescriptor(_class2.prototype, "init", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "init"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "viewListPhilanthropist", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "viewListPhilanthropist"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "viewListRegister", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "viewListRegister"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "addPhilanthropist", [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "addPhilanthropist"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "addRegister", [_dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "addRegister"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "contributePrice", [_dec7], Object.getOwnPropertyDescriptor(_class2.prototype, "contributePrice"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "removeRegister", [_dec8], Object.getOwnPropertyDescriptor(_class2.prototype, "removeRegister"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "acceptRegister", [_dec9], Object.getOwnPropertyDescriptor(_class2.prototype, "acceptRegister"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "reedemOne", [_dec10], Object.getOwnPropertyDescriptor(_class2.prototype, "reedemOne"), _class2.prototype)), _class2)) || _class);
function reedemOne() {
  const _state = charity._getState();
  if (!_state && charity._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  const _contract = charity._create();
  if (_state) {
    charity._reconstruct(_contract, _state);
  }
  const _args = charity._getArgs();
  const _result = _contract.reedemOne(_args);
  charity._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(charity._serialize(_result, true));
}
function acceptRegister() {
  ...
  const _args = charity._getArgs();
  const _result = _contract.acceptRegister(_args);
  charity._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(charity._serialize(_result, true));
}
function removeRegister() {
  ...
  const _args = charity._getArgs();
  const _result = _contract.removeRegister(_args);
  charity._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(charity._serialize(_result, true));
}
function contributePrice() {
  const _state = charity._getState();
  if (!_state && charity._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = charity._getArgs();
  const _result = _contract.contributePrice(_args);
  charity._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(charity._serialize(_result, true));
}
function addRegister() {
  ...
  const _args = charity._getArgs();
  const _result = _contract.addRegister(_args);
  charity._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(charity._serialize(_result, true));
}
function addPhilanthropist() {
  const _state = charity._getState();
  if (!_state && charity._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = charity._getArgs();
  const _result = _contract.addPhilanthropist(_args);
  charity._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(charity._serialize(_result, true));
}
function viewListRegister() {
  const _state = charity._getState();
  if (!_state && charity._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = charity._getArgs();
  const _result = _contract.viewListRegister(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(charity._serialize(_result, true));
}
function viewListPhilanthropist() {
  const _state = charity._getState();
  if (!_state && charity._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = charity._getArgs();
  const _result = _contract.viewListPhilanthropist(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(charity._serialize(_result, true));
}
function init() {
  const _state = charity._getState();
...
export { acceptRegister, addPhilanthropist, addRegister, contributePrice, init, reedemOne, removeRegister, viewListPhilanthropist, viewListRegister };
